...
using use = useUsing("use")`,
  ...
  [SkillNames.VUE]: {
    ...
    label: "Python",
    shortDescription:
      "clean syntax, serious power, and the go-to for scripting, backend, and AI work.",
    color: "#3776ab",
  ...
  [SkillNames.FIREBASE]: {
    ...
    label: "Supabase",
    shortDescription:
      "open-source backend tools with auth, database, and realtime features that ship fast.",
    color: "#3ecf8e",
  ...
  [SkillNames.NGINX]: {
    ...
    name: "nginx",
    label: "C++",
    shortDescription: "high-performance systems programming when you need tight control and speed.",
    color: "#00599c",
