...
const projects: Project[] = [
  {
    id: "sorting-algo-visualizer",
    category: "Algorithm Visualizer",
    title: "Sorting Algo Visualizer",
    src: "/assets/projects-screenshots/sorting-algo-visualizer/landing.png",
    screenshots: ["landing.png", "code_intutions.png", "Screenshot 2026-03-10 195021.png"],
    skills: {
      frontend: [
    ...
    live: "https://sorting-algo-visualizer-cyan.vercel.app/",
    github: "https://github.com/Abhiuday02/Sorting-algo-visualizer",
    get content() {
      return (
        <div>
          <TypographyP className="font-mono text-2xl text-center">
            Watch algorithms come to life — one bar at a time.
          </TypographyP>
          <TypographyP className="font-mono ">
            Sorting Algo Visualizer is an interactive tool that brings classic
            sorting algorithms to life with smooth, real-time animations. Pick
            an algorithm, hit play, and watch the magic unfold. Perfect for
            students, developers, or anyone who wants to truly understand how
            sorting works under the hood.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <TypographyH3 className="my-4 mt-8">Algorithms Supported</TypographyH3>
          <p className="font-mono mb-2">
            Visualize popular sorting algorithms including Bubble Sort, Selection
            Sort, Insertion Sort, Merge Sort, and Quick Sort — each with
            color-coded comparisons and swaps so you never miss a step.
          </p>
          <SlideShow
            images={[
              `${BASE_PATH}/sorting-algo-visualizer/landing.png`,
              `${BASE_PATH}/sorting-algo-visualizer/code_intutions.png`,
              `${BASE_PATH}/sorting-algo-visualizer/Screenshot 2026-03-10 195021.png`,
            ]}
          />
          <TypographyH3 className="my-4 mt-8">Interactive Controls</TypographyH3>
          <p className="font-mono mb-2">
            Adjust the array size and animation speed on the fly. Generate a
            new random array anytime and replay the sort as many times as you
            like — full control, zero friction.
          </p>
          <TypographyH3 className="my-4 mt-8">Clean UI</TypographyH3>
          <p className="font-mono mb-2">
            A minimal, distraction-free interface keeps the focus on the
            algorithm. Each bar lights up differently during comparisons,
            swaps, and when the array is fully sorted — making the logic
            visually intuitive.
          </p>
          <p className="font-mono mb-2 mt-8 text-center">
            Because the best way to learn an algorithm is to see it in action.
          </p>
        </div>
      );
    },
    ...
    get content(): JSX.Element {
      return (
        <div>
          ...
          <p className="font-mono mb-2">
            Powered by Python-based tooling, this setup allows us to keep the content
